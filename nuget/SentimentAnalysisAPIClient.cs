...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/sentimentanalysis";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SentimentAnalysisAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SentimentAnalysisAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SentimentAnalysisQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SentimentAnalysisQueryOptions options)
        {
        ...
        public ResponseObj Execute(SentimentAnalysisQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SentimentAnalysisQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SentimentAnalysisQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SentimentAnalysisQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SentimentAnalysisQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SentimentAnalysisQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SentimentAnalysisQueryOptions options)
        {
