/*
 * Sentiment Analysis API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Sentiment Analysis API.
 * API Documentation: https://docs.apiverve.com/ref/sentimentanalysis
 */
...
namespace APIVerve.Examples
{
    class SentimentAnalysisExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/sentimentanalysis";

        /// <summary>
        /// Make a POST request to the Sentiment Analysis API
        /// </summary>
        static async Task<JsonDocument> CallSentimentAnalysisAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;I&#x27;m so excited that tomorrow is going to be sunny! Can&#x27;t wait!&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Sentiment Analysis API...\n");

            var result = await CallSentimentAnalysisAPI();
